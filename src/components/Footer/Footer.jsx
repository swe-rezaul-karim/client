const Footer = () => {
  return (
    <div className="bg-neutral text-neutral-content">
      <footer className="container mx-auto md:px-32 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <nav>
            <h6 className="footer-title text-lg font-semibold text-gray-100 mb-4">Services</h6>
            <ul>
          ...
          <nav>
            <h6 className="footer-title text-lg font-semibold text-gray-100 mb-4">Company</h6>
            <ul>
          ...
          <nav>
            <h6 className="footer-title text-lg font-semibold text-gray-100 mb-4">Legal</h6>
            <ul>
          ...
          <nav>
            <h6 className="footer-title text-lg font-semibold text-gray-100 mb-4">Follow Us</h6>
